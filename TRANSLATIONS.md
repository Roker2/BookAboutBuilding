# Translations of BookAboutBuilding

> **Important:**
> This .md was taken from [google/comprehensive-rust](https://github.com/google/comprehensive-rust/blob/main/TRANSLATIONS.md). Thank them for that

We would love to have your help with translating the book into other
languages! 
...
These reviewers are often Googlers, but they don't have to be.

When reviewing a translation, please keep in mind that translations are a labour
of love. Someone spends their free time translating the book because they want
to bring Android to users who want to build this OS.
